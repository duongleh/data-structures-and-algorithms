...
class TestLinkedList(unittest.TestCase):
    ...
    def test_insert_node(self):
        ...
        self.assertEqual((str(e.exception)), "Invalid node")
        self.assertEqual(str(self.linked_list), "3, 6, 0, 4, 1, 7, 5, 2, 8")
        ...
        self.assertEqual(str(self.linked_list), "9, 3, 6, 0, 4, 10, 1, 7, 5, 2, 8, 11")
    ...
    def test_delete_node(self):
        ...
        self.assertEqual(str(self.linked_list), "3, 6, 0, 4, 10, 1, 7, 5, 2, 8")
        ...
        self.assertEqual((str(e.exception)), "Invalid index")
        self.assertEqual(str(self.linked_list), "6, 0, 4, 10, 1, 5, 2")
    ...
    def test_reverse_linked_list(self):
        ...
        self.assertEqual(str(self.linked_list), "11, 8, 2, 5, 7, 1, 10, 4, 0, 6, 3, 9")
